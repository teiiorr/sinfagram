...
import 'package:sinfagram/screens/Profile/edit_profile.dart';
import 'package:sinfagram/screens/Posts/postView_model.dart';
import 'package:sinfagram/screens/Story/storyview.dart';
import 'package:sinfagram/screens/settings/settings.dart';
...
class Tagged extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        children: <Widget>[Text("Hozircha rasm yoʻq")],
      ),
    );
  }
}
