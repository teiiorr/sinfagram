...
import 'package:sinfagram/widgets/SearchBox.dart';
import 'package:sinfagram/widgets/ctag.dart';
import 'dart:math';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:sinfagram/screens/Posts/postView_model.dart';
    ...
    return Column(
      children: <Widget>[
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: <Widget>[
              tagBuild('Sayohat', Colors.pink, context),
              tagBuild('Arxitektura', Colors.blue, context),
              tagBuild('Sayohat', Colors.orange, context),
              tagBuild('Texnologiya', Colors.red, context),
              tagBuild('Flutter', cgen(_colors), context),
              tagBuild('Python', cgen(_colors), context),
              tagBuild('Reactjs', cgen(_colors), context),
              tagBuild('Biznes', cgen(_colors), context),
              tagBuild('Dizayn', cgen(_colors), context),
              tagBuild('Moda', cgen(_colors), context),
              tagBuild('Musiqa', cgen(_colors), context),
            ],
          ),
        ),
        // SizedBox(
